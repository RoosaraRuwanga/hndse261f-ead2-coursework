...
public class ItemController {
    ...
    public Item getItemByID(@PathVariable int item_id) {
        return obj.getItemById(item_id);
    }

    // get item by ingredient 1 column
    @GetMapping(path = "/itemingredient1/{ingredient1_id}")
    public List<Item> SearchByIngredient1(@PathVariable int ingredient1_id) {
        return obj.SearchByIngredient1(ingredient1_id);
    }

    // get item by ingredient 2 column
    @GetMapping(path = "/itemingredient2/{ingredient2_id}")
    public List<Item> SearchByIngredient2(@PathVariable int ingredient2_id) {
        return obj.SearchByIngredient2(ingredient2_id);
    }
    ...
    @PostMapping(path = "/items/{item_id}/consume")
    public void consumeIngredients(@PathVariable int item_id) {
        obj.consumeIngredientsForItem(item_id);
    }
